...
class SkillAssignController extends BasePanelController
{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            reqAccess: 60,
            title: "Skill Assign",
            viewTemplate: "panel/skills.assign.html.twig",
            validationRules: [
    ...
    protected function prepareData(): array
    {
        ...
        if ($_GET["type"] != "update" && DB::Connection()->Count("SELECT COUNT(*) FROM skills_assign WHERE SkillID = :SkillID AND ItemID = :ItemID", [
                [":SkillID", $_POST["SkillID"], PDO::PARAM_INT],
                [":ItemID", $_POST["ItemID"], PDO::PARAM_INT]
            ]) > 0)
        {
            $this->response_json(["msg" => ["SkillID" => ["SkillID and ItemID are already exists."]]], 403);
        }
