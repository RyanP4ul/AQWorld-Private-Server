...
class QuestRequirementController extends BasePanelController
{

    public function __construct()
    {
        parent::__construct(
            table: "quests_requirements",
            reqAccess: 40,
            title: "Quests Requirements",
            viewTemplate: "panel/quests.requirements.html.twig",
            validationRules: [
    ...
    protected function prepareData(): array
    {
        ...
        if ($_GET["type"] != "update" && DB::Connection()->Count("SELECT COUNT(*) FROM quests_requirements WHERE QuestID = :QuestID AND ItemID = :ItemID", [
